    ...
    <main className="min-h-screen overflow-hidden bg-[#020617] text-white">
        ...
        <div className="flex items-center gap-3">
          {!isLoaded ? null : isSignedIn ? (
            <>
              <a
                href="/dashboard"
                className="cursor-pointer rounded-full bg-cyan-300 px-5 py-2.5 text-sm font-black text-black transition-all duration-200 hover:-translate-y-0.5 hover:bg-cyan-200"
              >
                Dashboard
              </a>
              <UserButton />
            ...
            <>
              <SignInButton mode="modal">
                <button className="cursor-pointer rounded-full border border-white/15 bg-white/10 px-5 py-2.5 text-sm font-bold backdrop-blur-xl transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:text-black">
                  Sign In
                </button>
              </SignInButton>

              <SignUpButton mode="modal">
                <button className="cursor-pointer rounded-full bg-cyan-300 px-5 py-2.5 text-sm font-black text-black transition-all duration-200 hover:-translate-y-0.5 hover:bg-cyan-200">
                  Get Started
                </button>
              </SignUpButton>
            </>
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-16 px-6 pb-24 pt-14 lg:grid-cols-[0.95fr_1.05fr]">
        <div>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            {isSignedIn ? (
              <a
                href="/dashboard"
                className="cursor-pointer rounded-full bg-cyan-300 px-8 py-4 text-center font-black text-slate-950 shadow-[0_0_60px_rgba(103,232,249,0.35)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-cyan-200"
              >
                Find My First Leads
              </a>
            ) : (
              <SignUpButton mode="modal">
                <button className="cursor-pointer rounded-full bg-cyan-300 px-8 py-4 font-black text-slate-950 shadow-[0_0_60px_rgba(103,232,249,0.35)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-cyan-200">
                  Find My First Leads
                </button>
              </SignUpButton>
            )}
            ...
            <a
              href="#features"
              className="cursor-pointer rounded-full border border-white/15 bg-white/[0.06] px-8 py-4 text-center font-bold backdrop-blur transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:text-black"
            >
              View Demo
            </a>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative rounded-[2rem] border border-white/15 bg-white/[0.08] p-4 shadow-2xl backdrop-blur-2xl">
